...
void main() {
  ...
  group('RecentCalculatorsNotifier', () {
    ...
    test('загружает сохранённые калькуляторы при инициализации', () async {
      SharedPreferences.setMockInitialValues({
    ...
    test('addRecent добавляет калькулятор в начало списка', () async {
      SharedPreferences.setMockInitialValues({});
      final container = ProviderContainer();
      addTearDown(container.dispose);
    ...
    test('addRecent перемещает существующий калькулятор в начало', () async {
      SharedPreferences.setMockInitialValues({
    ...
    test('addRecent ограничивает список до 10 элементов', () async {
    ...
    test('addRecent канонизирует legacy ID', () async {
      SharedPreferences.setMockInitialValues({});
      final container = ProviderContainer();
      addTearDown(container.dispose);
    ...
    test('addRecent игнорирует несуществующие калькуляторы', () async {
      SharedPreferences.setMockInitialValues({});
      final container = ProviderContainer();
      addTearDown(container.dispose);
    ...
    test('clearRecent очищает весь список', () async {
      SharedPreferences.setMockInitialValues({
        'recent_calculators': ['brick', 'tile', 'paint_universal'],
      });
    ...
    test('removeRecent удаляет конкретный калькулятор', () async {
      SharedPreferences.setMockInitialValues({
        'recent_calculators': ['brick', 'tile', 'paint_universal'],
      });
    ...
    test('removeRecent канонизирует legacy ID перед удалением', () async {
      SharedPreferences.setMockInitialValues({
    ...
    test('сохраняет изменения в SharedPreferences', () async {
      SharedPreferences.setMockInitialValues({});
      final container = ProviderContainer();
      addTearDown(container.dispose);
    ...
    test('фильтрует несуществующие калькуляторы при загрузке', () async {
      SharedPreferences.setMockInitialValues({
        'recent_calculators': [
          'brick',
          'nonexistent_calc',
    ...
    test('мигрирует legacy ID при загрузке', () async {
      SharedPreferences.setMockInitialValues({
        'recent_calculators': [
          'brick',
          'walls_paint', // legacy
    ...
    test('удаляет дубликаты при миграции', () async {
      SharedPreferences.setMockInitialValues({
        'recent_calculators': [
    ...
    test('сохраняет порядок элементов', () async {
      SharedPreferences.setMockInitialValues({});
      final container = ProviderContainer();
      addTearDown(container.dispose);
    ...
    test('обрабатывает пустые сохранённые данные', () async {
      SharedPreferences.setMockInitialValues({
    ...
    test('множественные операции работают последовательно', () async {
      SharedPreferences.setMockInitialValues({});
      final container = ProviderContainer();
      addTearDown(container.dispose);
