  ...
  Widget _buildCalculatorsList(
    ...
    return Column(
      children: calculators.map((calc) {
        ...
        final categoryLabel =
            '${loc.translate(calc.category.translationKey)} → ${loc.translate(calc.subCategoryKey)}';
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  ...
                  subtitle: Text(
                    '${dialogLoc.translate(calculator.category.translationKey)} → ${dialogLoc.translate(calculator.subCategoryKey)}',
                  ),
                  trailing: IconButton(
