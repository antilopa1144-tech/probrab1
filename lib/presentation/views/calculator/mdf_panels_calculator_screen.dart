      ...
      children: [
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              Text(_loc.translate('mdf_panels_calc.label.wall_area'), style: CalculatorDesignSystem.bodyMedium.copyWith(color: CalculatorColors.getTextPrimary(_isDark), fontWeight: FontWeight.w600)),
