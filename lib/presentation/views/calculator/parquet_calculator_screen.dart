...
class _ParquetCalculatorScreenState extends State<ParquetCalculatorScreen> {
  ...
  void _shareCalculation() {
    ...
    SharePlus.instance.share(ShareParams(text: text, subject: _loc.translate('parquet_calc.title')));
  }
    ...
    return Column(
      children: [
        Row(
          ...
          children: [
            Text(_loc.translate('parquet_calc.label.area'), style: CalculatorDesignSystem.bodyMedium.copyWith(color: CalculatorColors.textSecondary)),
      ...
      child: Column(
        children: [
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text(_loc.translate('parquet_calc.label.pack_area'), style: CalculatorDesignSystem.bodyMedium.copyWith(color: CalculatorColors.textSecondary)),
          ...
          Slider(value: _packArea, min: 1.0, max: 4.0, divisions: 12, activeColor: _accentColor, onChanged: (v) { setState(() { _packArea = v; _update(); }); }),
          const SizedBox(height: 8),
          SwitchListTile(
