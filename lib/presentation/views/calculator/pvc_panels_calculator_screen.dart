...
class _PvcPanelsCalculatorScreenState extends ConsumerState<PvcPanelsCalculatorScreen>
  ...
  _PvcPanelsResult _calculate() {
    ...
    final result = CalculatorEngine.calculate('walls_pvc_panels', inputs);
      ...
      children: [
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              Text(_loc.translate('pvc_panels_calc.label.total_area'), style: CalculatorDesignSystem.bodyMedium.copyWith(color: CalculatorColors.getTextPrimary(_isDark), fontWeight: FontWeight.w600)),
