...
const ProjectModelSchema = CollectionSchema(
  ...
  properties: {
    r'calculationIdsJson': PropertySchema(
      id: 0,
      name: r'calculationIdsJson',
...
int _projectModelEstimateSize(
  ...
  bytesCount += 3 + object.calculationIdsJson.length * 3;
...
void _projectModelSerialize(
  ...
  writer.writeString(offsets[0], object.calculationIdsJson);
  ...
  writer.writeDouble(offsets[8], object.spentAmount);
  writer.writeDateTime(offsets[9], object.startDate);
  writer.writeDouble(offsets[10], object.totalBudget);
}
...
ProjectModel _projectModelDeserialize(
  ...
  object.calculationIdsJson = reader.readString(offsets[0]);
  object.completionDate = reader.readDateTimeOrNull(offsets[1]);
  ...
  object.spentAmount = reader.readDouble(offsets[8]);
  object.startDate = reader.readDateTimeOrNull(offsets[9]);
  object.totalBudget = reader.readDouble(offsets[10]);
  return object;
}
...
extension ProjectModelQuerySortBy
  ...
  QueryBuilder<ProjectModel, ProjectModel, QAfterSortBy> sortByMetadataJson() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProjectModel, ProjectModel, QAfterSortBy> sortByObjectType() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProjectModel, ProjectModel, QAfterSortBy> sortBySpentAmount() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProjectModel, ProjectModel, QAfterSortBy> sortByTotalBudget() {
    return QueryBuilder.apply(this, (query) {
...
extension ProjectModelQuerySortThenBy
  ...
  QueryBuilder<ProjectModel, ProjectModel, QAfterSortBy> thenByMetadataJson() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'metadataJson', Sort.asc);
    });
  }
  ...
  QueryBuilder<ProjectModel, ProjectModel, QAfterSortBy> thenByObjectType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'objectType', Sort.asc);
    });
  }
  ...
  QueryBuilder<ProjectModel, ProjectModel, QAfterSortBy> thenBySpentAmount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'spentAmount', Sort.asc);
    });
  }
  ...
  QueryBuilder<ProjectModel, ProjectModel, QAfterSortBy> thenByTotalBudget() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'totalBudget', Sort.asc);
    });
  }
...
extension ProjectModelQueryWhereDistinct
  ...
  QueryBuilder<ProjectModel, ProjectModel, QDistinct> distinctBySpentAmount() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProjectModel, ProjectModel, QDistinct> distinctByTotalBudget() {
    return QueryBuilder.apply(this, (query) {
...
extension ProjectModelQueryProperty
  ...
  QueryBuilder<ProjectModel, String, QQueryOperations> metadataJsonProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProjectModel, String, QQueryOperations> objectTypeProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProjectModel, double, QQueryOperations> spentAmountProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProjectModel, double, QQueryOperations> totalBudgetProperty() {
    return QueryBuilder.apply(this, (query) {
