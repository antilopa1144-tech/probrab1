...
class CalculateBrick extends BaseCalculator {
  ...
  String? validateInputs(Map<String, double> inputs) {
    ...
    if (area <= 0 && wallWidth != null && wallHeight != null) {
      if (wallWidth <= 0) return positiveValueMessage('wallWidth');
      if (wallHeight <= 0) return positiveValueMessage('wallHeight');
    }
  ...
  CalculatorResult calculate(
    ...
    final wallThickness = getIntInput(
      inputs,
      'wallThickness',
      defaultValue: 1,
      minValue: 0,
    ...
    final workingConditions = getIntInput(
      inputs,
      'workingConditions',
      defaultValue: 1,
      minValue: 1,
    ...
    final costs = [
      ...
      calculateCost(
        cementNeeded / 50,
        cementPrice?.price,
      ), // цемент продаётся мешками по 50 кг
