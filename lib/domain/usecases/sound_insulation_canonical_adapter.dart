...
CanonicalCalculatorContractResult calculateCanonicalSoundInsulation(
  ...
  if (system == 0) {
    ...
    final gklSheets =
        (area *
                spec.materialRule<num>('rockwool_reserve').toDouble() *
                spec.materialRule<num>('gkl_reserve2layers').toDouble() /
  ...
  if (system == 1) {
    ...
    final dubels =
        (zipsPanels *
                spec.materialRule<num>('zips_dubels_per_panel').toDouble() *
                spec.materialRule<num>('zips_dubel_reserve').toDouble())
            .ceil();
    final gklOverlay =
        (area *
                spec.materialRule<num>('zips_reserve').toDouble() /
  ...
  if (system == 2) {
    ...
    final screedBags =
        (area *
                spec.materialRule<num>('screed_thickness').toDouble() *
  ...
  if (system == 1) {
    warnings.add(
      '\u0421\u0438\u0441\u0442\u0435\u043c\u0430 \u0417\u0418\u041f\u0421 \u0442\u0440\u0435\u0431\u0443\u0435\u0442 \u0440\u043e\u0432\u043d\u043e\u0433\u043e \u043e\u0441\u043d\u043e\u0432\u0430\u043d\u0438\u044f',
    );
  }
