...
final List<CalculatorDefinitionV2> wallsCalculators = [
  ...
  CalculatorDefinitionV2(
      ...
      beforeHints: [
        const CalculatorHint(type: HintType.tip, messageKey: 'hint.walls.shag_stoek_60_sm'),
        const CalculatorHint(type: HintType.tip, messageKey: 'hint.walls.ispolzuyte_zvukoizolyatsiyu_mezhdu_listami'),
        const CalculatorHint(type: HintType.tip, messageKey: 'hint.walls.proverte_vertikalnost_stoek_urovnem'),
        const CalculatorHint(type: HintType.tip, messageKey: 'hint.walls.shpaklevku_nanosite_v_dva'),
      ],
      afterHints: [
        const CalculatorHint(type: HintType.tip, messageKey: 'hint.walls.shag_stoek_60_sm'),
        const CalculatorHint(type: HintType.tip, messageKey: 'hint.walls.ispolzuyte_zvukoizolyatsiyu_mezhdu_listami'),
  ...
  CalculatorDefinitionV2(
      ...
      beforeHints: [
        const CalculatorHint(type: HintType.tip, messageKey: 'hint.walls.proverte_sovpadenie_risunka_rapporta'),
        const CalculatorHint(type: HintType.tip, messageKey: 'hint.walls.rekomenduetsya_dobavit_10_k'),
        const CalculatorHint(type: HintType.tip, messageKey: 'hint.walls.ispolzuyte_lazernyy_uroven_dlya'),
        const CalculatorHint(type: HintType.tip, messageKey: 'hint.walls.kley_podbirayte_po_tipu'),
      ],
      afterHints: [
        const CalculatorHint(type: HintType.tip, messageKey: 'hint.walls.proverte_sovpadenie_risunka_rapporta'),
        const CalculatorHint(type: HintType.tip, messageKey: 'hint.walls.rekomenduetsya_dobavit_10_k'),
