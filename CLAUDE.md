# Прораб AI — Инструкции для Claude
...
**Прораб AI** — кроссплатформенное мобильное приложение (Android/iOS) для профессионального расчёта строительных материалов.
...
- 7 языков (RU, EN, KZ, KG, TJ, TM, UZ)
- 5 регионов с ценами (Москва, СПб, Екб, Краснодар, Регионы)
- 95%+ покрытие тестами
- 71,000+ строк кода
